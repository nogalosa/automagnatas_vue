<template>
    <div class="container">
        <div class="login--container">
            <h3>Registracija</h3>
            <p>Žvaigždute (<font color="red">*</font>) pažymėti laukeliai yra privalomi</p>
            ...
            <!-- TODO: recapcha -->
            <router-link to="/profile" class="button">Registracija</router-link>
        </div>
    </div>
</template>
